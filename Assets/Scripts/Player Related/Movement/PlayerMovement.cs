...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Header("Animatior")]
    [SerializeField] private Animator axeGun;
    ...
    private void Weapon()
    {
        axeGun.SetBool("TrucoChimba?", false);
        axeGun.SetBool("Look?", false);
        
        if (inputManager.Trick)
        {
            axeGun.SetBool("TrucoChimba?", true);
            axeGun.SetBool("Look?", false);
            Debug.Log("hice un truco re chimba");
        }
        if (inputManager.Look)
        {

            axeGun.SetBool("Look?", true);
            axeGun.SetBool("TrucoChimba?", false);
            Debug.Log("mire");
        }
    }
